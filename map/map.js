...
function initMap() {
  ...
  addMarkerWithWindow('Apinapatsas', apinapatsasCont, '../img/attractions.svg', apinapatsasLoc, map);
  addMarkerWithWindow('Höyhtyän grilli', hoyhtyanGrilliCont, '../img/restaurants.svg', hoyhtyanGrilliLoc, map);
  addMarkerWithWindow('Lääketieteellinen Tiedekunta', laakisCont, '../img/campuses.svg', laakisLoc, map);
  addMarkerWithWindow('Kauppuri 5', kauppuri5Cont, '../img/restaurants.svg', kauppuri5Loc, map);
  addMarkerWithWindow('Kontinkankaan kampus (AMK)', kontinkangasAMKCont, '../img/campuses.svg', kontinkangasAMKLoc, map);
  addMarkerWithWindow('Paska Kaupunni', paskaKaupunniCont, '../img/attractions.svg', paskaKaupunniLoc, map);
  addMarkerWithWindow('Teekkaritalo', teekkaritaloCont, '../img/partyspots.svg', teekkaritaloLoc, map);
  addMarkerWithWindow('Toripolliisi', toripolliisiCont, '../img/attractions.svg', toripolliisiLoc, map);
